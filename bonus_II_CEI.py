...
For 30 observations:
  Bayesian Optimization (EI): 0.4586
  Random Search: 0.3469
For 60 observations:
  Bayesian Optimization (EI): 0.5964
  Random Search: 0.4880
For 90 observations:
  Bayesian Optimization (EI): 0.6423
  Random Search: 0.5650
For 120 observations:
  Bayesian Optimization (EI): 0.6652
  Random Search: 0.6126
For 150 observations:
  Bayesian Optimization (EI): 0.6790
